import EditAttributePage from "@/components/pages/dashboard/products/attributes/editAttribute/EditAttribute";

import { singleAttribute } from "@/services/dashboard/products/attributesService";
