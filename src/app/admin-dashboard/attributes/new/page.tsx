import NewAttributePage from "@/components/pages/dashboard/products/attributes/newAttribute/NewAttribute";
...
export default async function NewAttribute() {
  ...
  return <NewAttributePage permissions={getUserInfo?.user?.permissions} />;
}
