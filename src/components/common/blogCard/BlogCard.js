...
export default function BlogCard({classes  , slug ,  image , title, categories }){
  ...
  return(
    <div className={`${classes} border dark:border-dark-25 bg-white-100 dark:bg-dark-25 flex flex-col items-start rounded-md`}>
      ...
      <ShowImg alt={title} width={500} height={500} bucketName={image.bucket} fileName={image.location} className="w-full h-auto mb-2 rounded-md"/>
      </Link>
