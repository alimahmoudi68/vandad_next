...
const MasterModal: React.FC<MasterModalProps> = ({ children, close ,title }) => {
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-bgModal-100 dark:bg-bgModalDark-200" onClick={handleBackgroundClick}>
      <div 
        className="w-4/5 h-fit max-w-[650px] bg-white-100 dark:bg-cardDark-100 rounded-3xl p-5 shadow-lg relative"
