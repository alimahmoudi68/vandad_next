...
import {removeComment} from '@/services/adminDashboard/blog/blogCommentsService';
import { IItemsCommentBlog } from "@/types/blogComment";


interface ModalDeleteCommentBlogProps {
  item: IItemsCommentBlog;
  close: () => void;
  done: (id: number) => void;
}

const ModalDeleteCommentBlog: React.FC<ModalDeleteCommentBlogProps> = ({ item, close, done }) => {
  ...
  return (
    <>
      <MasterModal close={close} title={'حذف نظر'}>
...
export default ModalDeleteCommentBlog;
