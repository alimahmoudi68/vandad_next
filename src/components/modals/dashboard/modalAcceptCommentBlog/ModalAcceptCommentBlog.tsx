...
import {acceptComment} from '@/services/adminDashboard/blog/blogCommentsService';
import { IItemsCommentBlog } from "@/types/blogComment";


interface ModalAcceptCommentBlogProps {
  item: IItemsCommentBlog;
  close: () => void;
  done: (id: number) => void;
}

const ModalAcceptCommentBlog: React.FC<ModalAcceptCommentBlogProps> = ({ item, close, done }) => {
...
export default ModalAcceptCommentBlog;
