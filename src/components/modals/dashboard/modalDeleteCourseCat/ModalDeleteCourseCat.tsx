...
import {removeCategory} from '@/services/adminDashboard/course/courseCatsService';
...
interface ModalDeleteCourseCatProps {
  item: ICategory;
  close: () => void;
  show: boolean;
  done: (id: number) => void;
...
const ModalDeleteCourseCat: React.FC<ModalDeleteCourseCatProps> = ({ item, close, done }) => {
  ...
  return (
    <>
      <MasterModal close={close} title={'حذف دسته بندی دوره'}>
...
export default ModalDeleteCourseCat;
