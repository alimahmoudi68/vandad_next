...
import {rejectComment} from '@/services/adminDashboard/tv/tvCommentsService';
import { IItemsCommentTv } from "@/types/tvComment";


interface ModalRejectCommentTvProps {
  item: IItemsCommentTv;
  close: () => void;
  done: (id: number) => void;
}

const ModalRejectCommentTv: React.FC<ModalRejectCommentTvProps> = ({ item, close, done }) => {
...
export default ModalRejectCommentTv;
