          ...
          <div className="w-full bg-white-100 dark:bg-cardDark-100 rounded-[10px] p-[20px]">
            {/* <div className="w-full h-[250px] md:h-[500px] mb-4 md:mb-8">
              <ShowImg
                ...
                bucketName={tv?.image?.bucket}
                fileName={tv?.image?.location}
                width={1000}
                height={1000}
                fill={true}
              />
            ...
            <div className="w-full flex items-center gap-1 mb-3 ">
              ...
              {tv.categories.map((cat: ITvCat, index: number) => (
                <Link
                  key={index}
                  href={`/tvs/category/${cat.slug}`}
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: DOMPurify.sanitize(tv.content),
              }}
            />
          </div>
