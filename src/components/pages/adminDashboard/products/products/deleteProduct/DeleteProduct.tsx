...
import { remove } from "@/store/productsAdmin";
import MasterModal from "@/components/modals/masterModal/MasterModal";
import Button from "@/components/common/button/Button";
import { removeProduct } from "@/services/adminDashboard/products/productsService";
...
export default function DeleteProductModal({ id }: { id: string }) {
  ...
  return (
    <MasterModal title="حذف محصول" close={handleCancel}>
      <span>آیا از حذف محصول مطمئن هستید؟</span>
