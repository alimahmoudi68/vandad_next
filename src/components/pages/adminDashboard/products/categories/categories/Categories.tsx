            ...
            categories.map((cat, index) => {
              return (
                <div key={index}>
                  <div className="w-full">
                    ...
                    <div className="w-full rounded-md bg-white-100 dark:bg-cardDark-100 py-5 px-5 my-5 md:px-0 flex flex-wrap items-center justify-start">
                      ...
                      <Link href={`/admin-dashboard/product-cats/${cat.id}`}>
                        ...
                        <Link href={`/admin-dashboard/product-cats/delete/${cat.id}`}>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                  ...
                  {cat.children?.map(
                    (child: IProductCat, childIndex: number) => (
                      <div key={childIndex} className="w-full md:pr-[40px]">
                        ...
                        <div className="w-full rounded-md bg-white-100 dark:bg-cardDark-100 py-5 px-5 my-5 md:px-0 flex flex-wrap items-center justify-start">
                          ...
                          <div className="w-full md:w-[10%] flex justify-end md:justify-center">
                            <Link
                              href={`/admin-dashboard/product-cats/${child.id}`}
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                ...
                                className="w-4 h-4 md:w-6 md:h-6 md:hover:stroke-primary-100 cursor-pointer"
                                onClick={() =>
                                  router.push(`/dashboard/cats/${child.id}`)
                                }
                              >
                                <path
                                  strokeLinecap="round"
                            ...
                            <Link
                              href={`/admin-dashboard/product-cats/delete/${child.id}`}
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
