...
import {
  singleComment,
  updateComment
} from "@/services/adminDashboard/blog/blogCommentsService";
...
interface EditBlogCommentPageProps {
  id: number;
}
...
export default function EditBlogCommentPage({ id }: EditBlogCommentPageProps) {
  ...
  const submitHandler = async (form: FormData | Record<string, any>) => {
    ...
    try {
      ...
      if (data.status === "success") {
        ...
        router.push("/admin-dashboard/blog/comments");
      } else {
