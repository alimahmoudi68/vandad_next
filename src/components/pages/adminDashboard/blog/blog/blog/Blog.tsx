...
import ModalRemove from '@/components/modals/dashboard/modalDeleteBlog/ModalDeleteBlog';
import SkeletonLoading from "@/components/common/skeletonLoading/SkeletonLoading";
import { getBlog } from "@/services/adminDashboard/blog/blogService";
...
export default function BlogPage() {
    ...
    const [currentItem, setCurrentItem] = useState<IBlog>();
    const [showModalRemove , setShowModalRemove] = useState(false);

    const stateModalRemove = (state: boolean, item: IBlog) => {
